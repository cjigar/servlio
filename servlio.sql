...
insert  into `city`(`iCityId`,`vCityName`,`iStateId`) values (1,'Aurangabad',5),(2,'Bakhtiarpur',5),(3,'Baniapur',5),(4,'Barahiya',5),(5,'Barauni',5),(6,'Bettiah',5),(7,'Bhabua',5),(8,'Bihar Sharif',5),(9,'Bodh Gaya',5),(10,'Buxar',5),(11,'Chhapra',5),(12,'Danapur',5),(13,'Darbhanga',5),(14,'Dighwara',5),(15,'Gaya',5),(16,'Gopalganj',5),(17,'Hajipur',5),(18,'Jehanabad',5),(19,'Katihar',5),(20,'Kharagpur',5),(21,'Kishanganj',5),(22,'Madhubani',5),(23,'Maharajganj',5),(24,'Mirganj',5),(25,'Motihari',5),(26,'Muzaffarpur',5),(27,'Nalanda',5),(28,'Patna',5),(29,'Purnia',5),(30,'Samastipur',5),(31,'Sasaram',5),(32,'Sitamarhi',5),(33,'Siwan',5),(34,'Sonepur',5),(35,'Bhavnagar',8),(36,'Baroda',8),(37,'Ahmedabad',8),(38,'Ankleshwar ',8),(39,'Bharoch',8),(40,'Bhuj',8),(41,'Bulsar',8),(42,'Bharuch',8),(43,'Dwarka',8),(44,'Div',8),(45,'Vadodara',8),(46,'Vapi ',8),(47,'Godhra',8),(48,'Rajkot',8),(49,'Sachin',8),(50,'Surat',8),(51,' Jamnagar',8),(52,'Porbandar',8),(53,'Mandvi',8),(54,'Vasco da Gama',7),(55,'Chapora',7),(56,'Dabolim',7),(57,'Madgaon',7),(58,'Panaji Port',7),(59,'Panjim',7),(60,'Talpona',7),(61,'Betul',7),(62,'Marmugao (Marmagao)',7),(63,'Kota',23),(64,'Boranada - Jodhpur',23),(65,'Jaipur',23),(66,'Banswara',23),(67,'Jaipur-Kanakpura',23),(68,'Jaipur-Sitapura',23),(69,'Jodhpur-Thar',23),(70,'Bhilwara',23),(71,'Bikaner',23),(72,'Udaipu',23),(73,'Jaisalmer',23),(74,'Munabao Rail Station',23),(75,'Jodhpur-Bhagat Ki Kothi',23),(76,'Jodhpur',23),(77,'Bhiwadi',23),(78,'Bhiwadi',23),(79,'Basni',23),(80,'Barmer Rail Station',23),(81,'Fani',52),(82,'Fenny',52),(83,'Pheni',52),(84,'Maheshpur',52),(85,'Mahespur',52),(86,'Ruhitia',52),(87,'Katalia',52),(88,'Bandua',52),(89,'Daulatpur',52),(90,'Daulatpur',52),(91,'Bangaon',52),(92,'North Gobindapur',52),(93,'Kalidaha',52),(94,'Majhbaria',52),(95,'Uttar Gobindapur',52),(96,'Maduai',52),(97,'Dhonsahadda',52),(98,'Madhuai',52),(99,'Sarish',52),(100,'Sarishadi',52),(101,'Rawalpindi',65),(102,'Kahuta',65),(103,'Haripur',65),(104,'Wah',65),(105,'Murree',65),(106,'Havelian',65),(107,'Khalabat',65),(108,'Kamra',65),(109,'Abbottabad',65),(110,'Gujar Khan',65),(111,'Topi',65),(112,'Hazro',65),(113,'Daultala',65),(114,'Sanjwal',65),(115,'Zaida',65),(116,'Ghasipur',64),(117,'Chak Langa',64),(118,'Nagial',64),(119,'Bidar',64),(120,'Bens',64),(121,'Chak Dilu',64),(122,'Manda',64),(123,'Harchhial',64),(124,'Jangian',64),(125,'Chak Mughlani',64),(126,'Ghasitpur',64),(127,'Ahbdupur',64),(128,'Gande',64),(129,'Chak Qazi',64),(130,'Tatrot',64),(131,'Gobindpur',64),(132,'Burial',64),(133,'Ditial',64),(134,'Juian',64),(135,'Dhudian',64),(136,'Rangpur',64),(137,'Sagar',64),(138,'Barsali',64),(139,'Naugraon',64),(140,'Mughal',64);
...
insert  into `company_location`(`iCompanyLocationId`,`iCompanyServiceId`,`iUserId`,`iCountryId`,`iStateId`,`iCityId`) values (1,1,1,15,8,37),(2,3,4,15,8,37);
...
insert  into `company_services`(`iCompanyServiceId`,`iUserId`,`iServiceId`,`vServiceName`,`iCategoryId`,`iCurrencyId`,`fPrice`,`vImage`,`vDescription`) values (1,1,3,'',5,0,100.00,'1340456546gallery_image1.jpg','teststs'),(2,1,3,'',5,0,100.00,'1340456724gallery_image1.jpg','teststs'),(3,4,3,'',5,0,100.00,'1340456819gallery_image1.jpg','teststs');
...
insert  into `country`(`iCountryId`,`vCountryName`) values (1,'Afghanistan'),(2,'Argentina'),(3,'Austria'),(4,'Bahrain'),(5,'Bangladesh'),(6,'Bhutan'),(7,'Brazil '),(8,'Canada'),(9,'China'),(10,'Colombia'),(11,'Denmark'),(12,'France'),(13,'Germany'),(14,'Iceland'),(15,'India'),(16,'Indonesia'),(17,'Iran'),(18,'Iraq'),(19,'Ireland'),(20,'Israel'),(21,'Italy'),(22,'Japan'),(23,'Kenya'),(24,'Malaysia'),(25,'Mexico'),(26,'Nepal'),(27,'Netherlands'),(28,'New Zealand'),(29,'Pakistan'),(30,'Russian'),(31,'Saudi Arabia'),(32,'Singapore'),(33,'Singapore'),(34,'Sri Lanka'),(35,'Switzerland'),(36,'Thailand'),(37,'United Kingdom '),(38,'United States'),(39,'Zimbabwe');
...
insert  into `currencies`(`iCurrencyId`,`vCurrencyVal`,`vCurrencySymbol`,`vCurrency`,`eStatus`) values (1,'GBP','£','British pound - £','Active'),(2,'USD','$','United States dollar - $','Active'),(3,'CAD','$','Canadian dollar - $','Active'),(4,'EUR','€','Euro - €','Active'),(5,'AFN','?','Afghan afghani - ?','Active'),(6,'ALL','L','Albanian lek - L','Active');
...
insert  into `services`(`iServiceId`,`iCategoryId`,`vService`,`eStatus`) values (1,1,'Personal Training','Active'),(2,5,'Pilates','Active'),(3,5,'Yoga','Active'),(4,5,'Jogging','Active'),(5,1,'Boxing','Active');
...
insert  into `state`(`iStateId`,`vStateName`,`iCountryId`) values (1,'Andra Pradesh',15),(2,'Arunachal Pradesh',15),(4,'Assam',15),(5,'Bihar',15),(6,'Chhattisgarh',15),(7,'Goa',15),(8,'Gujarat',15),(9,'Haryana',15),(10,'Himachal Pradesh',15),(11,'Jammu and Kashmir',15),(12,'Jharkhand',15),(13,'Karnataka',15),(14,'Kerala',15),(15,'Madya Pradesh',15),(16,'Maharashtra',15),(17,'Manipur',15),(18,'Meghalaya',15),(19,'Mizoram',15),(20,'Nagaland',15),(21,'Orissa',15),(22,'Punjab',15),(23,'Rajasthan',15),(24,'Sikkim',15),(25,'Tamil Nadu',15),(26,'Tripura',15),(27,'Uttaranchal',15),(28,'Uttar Pradesh',15),(29,'West Bengal',15),(30,'Badakhshan',1),(31,'Badghis',1),(32,'Farah',1),(33,'Faryab',1),(34,'Helmand',1),(35,'Herat',1),(36,'Kabul',1),(37,'Kunduz',1),(38,'Oruzgan',1),(39,'Paktia',1),(40,'Panjshir',1),(41,'Velayat-e Khowst',1),(42,'Velayat-e Nurestan',1),(43,'Wilayat-e Baghlan',1),(44,'Wilayat-e Balkh',1),(45,'Wilayat-e Bamyan',1),(46,'Wilayat-e Daykundi',1),(47,'Capital Governorate',4),(48,'Central Governorate',4),(49,'Muharraq',4),(50,'Northern Governorate',4),(51,'Southern Governorate',4),(52,'Borishal',5),(53,'Chittagong',5),(54,'Dhaka Division',5),(55,'Khulna Division',5),(56,'Rajshahi Division',5),(57,'Rangpur Division',5),(58,'Sylhet Division',5),(59,'Punjab',29),(60,'Sindh',29),(61,'North-West Frontier',29),(62,'Balochistan',29),(63,'Northern Areas',29),(64,'Azad Kashmir',29),(65,'Islamabad',29),(66,'Tianjin',9),(67,'Shandong',9),(68,'Fujian',9),(69,'Guangdong',9),(70,'Hainan',9),(71,'Shaanxi',9),(72,'Beijing',9),(73,'Jiangxi',9),(74,'Xinjiang',9),(75,'Shanxi',9),(76,'Suihua',9),(77,'Ningxia',9),(78,'Guizhou',9),(79,'Gansu',9),(80,'Xianggang',9),(81,'Shanghai',9),(82,'Jilin',9),(83,'Hunan',9),(84,'Jiangsu',9),(85,'Heilongjiang',9),(86,'Hubei',9),(87,'Zhejiang',9),(88,'Sichuan',9),(89,'Xizang',9),(90,'Henan',9),(91,'Seti',26),(92,'Bheri',26),(93,'Dhawalagiri',26),(94,'Gandaki',26),(95,'Bagmati',26),(96,'Karnali',26),(97,'Kosi',26),(98,'Lumbini',26),(99,'Mahakali',26),(100,'Mechi',26),(101,'Narayani',26),(102,'Rapti',26),(103,'Sagarmatha',26),(104,'zanakpur',26);
...
insert  into `users`(`iUserId`,`vFirstName`,`vLastName`,`vCompanyName`,`vCompanyLogo`,`vAddress`,`vEmail`,`vPassword`,`vWebSite`,`vTwitter`,`vPhone`,`dtAddedDate`,`eStatus`) values (1,NULL,NULL,'test','1340456219logo1.jpg',NULL,'test@gmail.com',NULL,'htttp://www.google.com','http://twitter.com/chuka','15131654','2012-06-23 18:26:59','1'),(2,NULL,NULL,'test','1340456546logo1.jpg',NULL,'test@gmail.com',NULL,'htttp://www.google.com','http://twitter.com/chuka','15131654','2012-06-23 18:32:26','1'),(3,NULL,NULL,'test','1340456724logo1.jpg',NULL,'test@gmail.com',NULL,'htttp://www.google.com','http://twitter.com/chuka','15131654','2012-06-23 18:35:24','1'),(4,NULL,NULL,'test','1340456819logo1.jpg',NULL,'test@gmail.com',NULL,'htttp://www.google.com','http://twitter.com/chuka','15131654','2012-06-23 18:36:59','1');
