...
(function($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            cellnumber:"Please enter a valid cell number.",
            ...
            urlwithoutht: "Please enter a valid URL.",
        ...
        prototype: {
            ...
            init: function() {
                ...
                .validateDelegate("[type='text'], [type='password'], [type='file'], select, textarea, " +
                    "[type='number'], [type='search'] ,[type='tel'], [type='url'], [type='urlwithoutht'], " +
        ...
        methods: {
            ...
            positive_number: function(value, element) {
                return this.optional(element) || value === "NA" ||
                value.match(/^\+?[0-9]*\.?[0-9]+$/);
            },
            ...
            // http://docs.jquery.com/Plugins/Validation/Methods/url
            urlwithoutht: function(value, element) {
                // contributed by Scott Gonzalez: http://projects.scottsplayground.com/iri/
